...
public class NewSql {
    public static void main(String args[]) throws ClassNotFoundException { //therows keyword is writtened after any method
        ...
        String quary="insert into students(name,id,address,mobile) values ('atul',9,'snpt','+917027289034')" ;
        try{
        ...
        try{
            ...
            if(rowsaffected>0){
                System.out.println("insert sucessfull"+" "+rowsaffected+" "+"rows effected");
            }
            else {
